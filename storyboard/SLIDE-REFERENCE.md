...
- Use slide-matched `.jpg` image filenames (`1S05.jpg`, `1S05a.jpg`), with art direction captured in the `Image` field
...
- [ ] Every image filename mirrors its slide ID and uses lowercase `.jpg`
